...
| `windows-opencode-pin.ps1` | `run_after_windows-opencode-pin.ps1.tmpl` | after | Verify installed stable v1 and reassert its Chocolatey hold; no installation or elevation |
