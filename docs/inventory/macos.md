...
| Agent of Empires | `~/.agent-of-empires/config.toml` | `dot_agent-of-empires/config.toml.tmpl` wrapper; canonical template in `.chezmoitemplates/agent-of-empires/config.toml.tmpl` |
